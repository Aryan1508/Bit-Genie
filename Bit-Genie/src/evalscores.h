...
namespace KingEval
{
    ...
    constexpr int virtual_mobility[28]
    {
        S(   0,   0), S(   0,   0), S(   0,   0), S( 101,  32),
        S(  38,  34), S( -13,  -1), S(   3,   0), S(   5,  -1),
        S(   4,   0), S(   7,   5), S(  -1,  -1), S(   8,   8), 
        S(  12,  12), S(   7,   7), S(   7,   3), S(   8,   7),
        S(   9,   7), S(   6,   8), S(  -2,  -1), S(  -1,  -2),
        S(  -6,  -5), S(   0,   4), S( -18, -16), S(  -6,  -8),
        S( -28, -23), S( -15, -11), S( -12,  -1), S( -18, -11),
    };
}