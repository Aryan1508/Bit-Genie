...
namespace PawnEval
{
    ...
    constexpr int passed[64] 
    {
        ...
        S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
        S( 258, 254), S( 246, 250), S( 257, 257), S( 265, 264),
        S( 253, 250), S( 248, 248), S( 281, 284), S( 287, 287),
        S( 151, 153), S( 151, 153), S( 143, 145), S( 163, 162),
        S( 146, 143), S( 126, 121), S( 150, 150), S( 154, 154),
        S(  63,  64), S(  51,  50), S(  53,  55), S(  40,  43),
        S(  32,  30), S(  42,  45), S(  51,  53), S(  61,  62),
        S(  25,  28), S(  20,  21), S(  17,  17), S(   8,  15), 
        S(  11,  11), S(  11,   8), S(  22,  21), S(  29,  31),
        S(  -1,  12), S(  -4,  -3), S(  -1,   4), S(   3,   9),
        S(  -2,  -2), S(  -7,  -6), S(  -8, -16), S(   0,  -2),
        S(  -5,   5), S(  -5,   2), S(   8,   5), S(   8,  21),
        S(  13,  17), S(  -9,  -4), S( -12, -15), S(  -2,  -3),
        S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
        S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    };
    ...
    constexpr int passer_blocked[64]
    {
        S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
        S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
        S( 121, 126), S( 137, 136), S( 142, 141), S( 152, 154),
        S( 125, 127), S(  96,  99), S(  72,  75), S(  71,  75),
        S(  69,  72), S(  46,  52), S(  71,  71), S(  73,  72),
        S(  68,  61), S(  36,  29), S(  20,  20), S(  24,  47),
        S(  26,  34), S(  17,  20), S(  16,  18), S(  16,  19),
        S(  14,  14), S(  11,  10), S(   4,   6), S(   1,   2),
        S(   9,  12), S(  -3,   0), S(  -1,   1), S(  -4,   3), 
        S(  -1,   1), S(  -8,  -9), S(  -1,  -2), S(   2,   4),
        S( -20,  -5), S( -16,  -8), S(  -8,  -3), S(  -9,   5),
        S(   1,   0), S(  -2,   0), S( -11, -12), S(  -1,  -2),
        S( -29, -19), S( -24, -12), S(  -2,  -5), S(  -6,  15),
        S(   6,  14), S(  -7,  -5), S(  -8,  -9), S( -18, -17),
        S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
        S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    };
    ...
    constexpr int passer_far_king = S(-20, 468);
}
