...
constexpr int PAWN_PSQT[64]
{
    ...
    S( -36,   25), S( -11,   -1), S(   1,   -6), S(   3,  -18), S(  31,  -24), S(  18,  -15), S(   9,   -8), S(  -7,    1), 
    S( -44,    1), S( -23,  -14), S(  -3,  -19), S(  11,  -15), S(  17,  -18), S(  10,  -20), S(  -4,  -19), S( -20,  -18), 
...
constexpr int PASSER[64]
{
    ...
    S(   1,  150), S( -17,  149), S( -22,   88), S( -12,   65), S( -27,   67), S( -19,   96), S( -48,  161), S( -32,  157), 
    S( -21,   83), S( -29,   61), S( -44,   36), S( -43,   13), S( -53,   28), S( -60,   56), S( -59,   90), S( -16,   81), 
    S( -19,   12), S( -61,   15), S( -40,   -5), S( -49,  -10), S( -53,  -12), S( -61,   -4), S( -66,   33), S( -15,   16), 
    S( -19,    6), S( -30,   -1), S( -36,  -12), S( -29,  -21), S( -27,  -33), S( -28,  -22), S( -12,   -9), S(   0,    1), 
    S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), 
};
...
constexpr int BLOCKED_PASSER[64]
{
    ...
    S(  37,   40), S(  22,   34), S( -12,   22), S( -16,   23), S( -23,   32), S( -31,   35), S(  -2,   46), S( -21,   43), 
    S(  20,   -8), S(  18,   30), S( -26,   13), S( -34,   13), S( -41,   24), S( -39,   33), S( -37,   54), S( -28,   32), 
...
{
    S(-142, -171), S( -34,  -63), S(  -6,   -3), S(   3,   31), S(  16,   47), S(  19,   58), S(  29,   61), S(  40,   61), 
    S(  54,   59), 
};

constexpr int KNIGHT_PSQT[64]
{
    S(-181,  -27), S(-161,   18), S( -83,   26), S(-133,   39), S( -39,   22), S( -97,  -66), S(-142,  -18), S(-131,  -49), 
    ...
    S( -22,   29), S(  -2,   13), S(  19,    1), S(  26,   12), S(  35,    9), S(  33,   -9), S(  20,    9), S(  -6,   28), 
    S( -50,    9), S( -20,    1), S(   2,  -31), S(   4,    0), S(  24,  -10), S(   6,  -31), S(  11,   -9), S( -29,    9), 
    S( -50,   38), S( -40,   13), S( -24,   -9), S(   3,  -12), S(  -3,  -18), S(  -1,  -23), S( -14,   16), S( -22,   53), 
    S( -91,   65), S( -42,   13), S( -63,   16), S( -38,   11), S( -31,    6), S( -26,    0), S( -35,   17), S( -66,   43), 
};

constexpr int BISHOP_VALUE = S( 421,  482);

constexpr int BISHOP_MOBILITY[14]
{
    S( -80,  -70), S( -87,   12), S( -59,   31), S( -41,   64), S( -14,   60), S(  -3,   68), S(  19,   75), S(  36,   73), 
    S(  50,   72), S(  58,   65), S(  68,   64), S(  75,   45), S(  78,   36), S( 121,   15), 
};
...
constexpr int BISHOP_PSQT[64]
{
    ...
    S(  -1,   36), S( -14,   26), S(  -8,   25), S(  15,   29), S(  14,   17), S(  -1,   11), S(  -8,   15), S(  16,    7), 
    S(   9,    2), S(  10,   28), S(   4,   24), S(   3,   18), S(   5,   26), S(  10,   16), S(  17,    6), S(  20,   15), 
    S(  22,   18), S(  17,    4), S(  17,   -4), S(  -3,   11), S(   6,   15), S(  18,   -2), S(  43,    6), S(  26,  -20), 
    S(  26,   17), S(  28,   -5), S(  12,    9), S(  -2,   22), S(   7,   27), S(   1,   31), S(  12,    1), S(  45,  -23), 
};
...
constexpr int ROOK_MOBILITY[15]
{
    ...
    S(  28,   69), S(  40,   63), S(  47,   63), S(  54,   55), S(  65,   48), S(  63,   44), S(  78,   21), 
};
...
constexpr int ROOK_PSQT[64]
{
    ...
    S( -27,    4), S( -37,   17), S( -28,   15), S( -25,   12), S( -15,    9), S(  -5,   -4), S(   6,  -15), S( -14,  -14), 
    S( -15,   11), S( -19,    9), S( -23,   17), S( -15,    4), S(  -7,   -1), S(  -1,    5), S(  16,  -12), S(  -7,  -13), 
};

constexpr int QUEEN_VALUE = S(1033, 1852);

constexpr int QUEEN_MOBILITY[28]
{
    S( -62,  -48), S( -70,  -36), S( -66,  -49), S( -53,  -57), S( -88,  -73), S( -77,   -1), S( -47,    4), S( -53,   99), 
    S( -36,   96), S( -32,  113), S( -22,  114), S( -13,  104), S(  -4,  111), S(   5,  100), S(  15,   93), S(  20,   96), 
...
constexpr int QUEEN_PSQT[64]
{
    ...
    S( -15,   87), S(   4,   62), S( -23,  105), S(  -7,  107), S( -20,  135), S(   2,   97), S(   5,  120), S(  14,   87), 
    S(  -3,   65), S( -12,   79), S(  -1,   54), S(  -3,   88), S(   3,   70), S(   0,   67), S(   9,   76), S(  27,   45), 
    S(  -7,   42), S(  10,   23), S(   0,   64), S(   4,   45), S(  11,   45), S(   6,   65), S(  30,   30), S(  27,   -3), 
    S(   1,   44), S(  14,   11), S(  17,   15), S(  22,   17), S(  20,   18), S(  29,   -4), S(  44,  -56), S(  65,  -89), 
...
{
    S(-142, -247), S(  90, -103), S(   1,  -38), S( -40,    8), S(  13,   23), S( -10,    8), S( -24,  -36), S( -31, -148), 
    ...
    S(  50,  -58), S(  92,  -54), S(  78,  -37), S( -16,  -15), S(  53,  -54), S(  -5,  -11), S(  77,  -57), S(  72,  -82), 
};

constexpr int KING_SAFETY_TABLE[100]
{
    S(  13,   13), S(   0,    0), S(  22,  -29), S( -39,   16), S( -28,   17), S( -37,   10), S( -42,   15), S( -17,  -17), 
    S( -55,   42), S( -28,  -48), S( -87,   11), S( -70,  -15), S( -43,  -44), S(-105,   40), S( -74,  -62), S(-128,  -75), 
    S(-126,   31), S(-105,  -28), S(-127,   40), S(-137,  -38), S(-206,  -92), S(-227,   25), S(-219,    4), S(-168,  -16), 
    S(-193,  -85), S(-202, -193), S(-239, -232), S(-224, -168), S(-288,  -66), S(-239, -115), S(-252,  -80), S(-287, -183), 
    S(-293, -209), S(-365, -277), S(-412, -277), S( -91,  -80), S(-370, -224), S(-316, -206), S(-369, -226), S(-242, -199), 
