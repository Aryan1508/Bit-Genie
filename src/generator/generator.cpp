...
namespace Generator
{
    ...
    {
        std::cout << "Starting generation on " << n_threads << " threads\n";
        ...
        std::uint64_t batch_size = target_fens / n_threads;
        ...
        while(n_fens <= (batch_size * n_threads))
        {
